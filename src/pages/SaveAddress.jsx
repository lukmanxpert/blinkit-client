              ...
              <div key={index} className={`border rounded p-3 flex gap-3 bg-white ${!address.status && 'hidden'}`}>
                ...
                <div className=' grid gap-10'>
                  <button onClick={() => {
                    setOpenEdit(true)
                    setEditData(address)
                  }} className='bg-green-200 p-1 rounded  hover:text-white hover:bg-green-600 cursor-pointer transition'>
                    <MdEdit />
                  </button>
                  <button onClick={() =>
                    handleDisableAddress(address._id)
                  } className='bg-red-200 p-1 rounded hover:text-white hover:bg-red-600 cursor-pointer transition'>
                    <MdDelete size={20} />
                  </button>
                </div>
              </div>
